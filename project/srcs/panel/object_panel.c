...
static void	selected_camera(void)
{
	printf("#\t\t\t\t\t       #\n");
	printf(":\t\t     %s        %s                  :\n", B_YLW, B_RESET);
	printf("+      %s %s             %s   %s   %s  %s          %s  %s      +\n"
			, B_WHT, B_RESET, B_YLW, B_WHT, B_YLW, B_RESET, B_WHT, B_RESET);
	printf("#      %s %s             %s  %s %s     ", B_WHT, B_RESET
			, B_YLW, B_WHT, B_YLW);
	printf("%s         %s %s  %s %s     #\n",
			B_RESET, B_WHT, B_RESET, B_WHT, B_RESET);
	printf(":      %s %s             %s  %s %s     %s         ",
			B_WHT, B_RESET, B_YLW, B_WHT, B_YLW, B_RESET);
...
static void	selected_object(void)
{
	printf("#\t\t\t\t\t       #\n");
	printf(":\t\t\t\t    %s        %s   :\n", B_YLW, B_RESET);
	printf("+     %s %s\t\t       %s   %s\t    %s   %s  %s   %s   +\n",
	...
	printf("#     %s %s\t\t      %s %s\t\t    %s  %s %s  %s %s  %s   #\n",
			B_WHT, B_RESET, B_WHT, B_RESET, B_YLW, B_WHT, B_YLW, B_WHT,
			B_YLW, B_RESET);
	printf(":     %s %s\t\t      %s %s\t\t    %s  %s %s  %s %s  %s   :\n",
			B_WHT, B_RESET, B_WHT, B_RESET, B_YLW, B_WHT, B_YLW, B_WHT,
			B_YLW, B_RESET);
